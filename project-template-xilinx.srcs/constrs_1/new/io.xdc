...
create_generated_clock -name ps2_clk -source [get_pins u_ip_pll/clk_in1] -divide_by 10 [get_pins u_ip_pll/clk_out2]
...
set_property -dict {PACKAGE_PIN H2 IOSTANDARD LVCMOS33} [get_ports pmod1_io1]
set_property -dict {PACKAGE_PIN G1 IOSTANDARD LVCMOS33} [get_ports pmod1_io2]
set_property -dict {PACKAGE_PIN F1 IOSTANDARD LVCMOS33} [get_ports pmod1_io3]
set_property -dict {PACKAGE_PIN E1 IOSTANDARD LVCMOS33} [get_ports pmod1_io4]
...
set_property MARK_DEBUG true [get_nets {spi_cmd[0]}]
set_property MARK_DEBUG true [get_nets {spi_cmd[1]}]
set_property MARK_DEBUG true [get_nets {spi_cmd[2]}]
set_property MARK_DEBUG true [get_nets {spi_cmd[3]}]
set_property MARK_DEBUG true [get_nets {spi_cmd[4]}]
set_property MARK_DEBUG true [get_nets {spi_cmd[5]}]
set_property MARK_DEBUG true [get_nets {spi_cmd[6]}]
set_property MARK_DEBUG true [get_nets {spi_cmd[7]}]
set_property MARK_DEBUG true [get_nets {spi_signal[0]}]
set_property MARK_DEBUG true [get_nets {spi_signal[1]}]
set_property MARK_DEBUG true [get_nets {spi_signal[2]}]
set_property MARK_DEBUG true [get_nets {spi_signal[3]}]
set_property MARK_DEBUG true [get_nets {spi_signal[4]}]
set_property MARK_DEBUG true [get_nets {spi_signal[5]}]
set_property MARK_DEBUG true [get_nets {spi_signal[6]}]
set_property MARK_DEBUG true [get_nets {spi_signal[7]}]

create_debug_core u_ila_0_1 ila
set_property ALL_PROBE_SAME_MU true [get_debug_cores u_ila_0_1]
set_property ALL_PROBE_SAME_MU_CNT 1 [get_debug_cores u_ila_0_1]
set_property C_ADV_TRIGGER false [get_debug_cores u_ila_0_1]
set_property C_DATA_DEPTH 1024 [get_debug_cores u_ila_0_1]
set_property C_EN_STRG_QUAL false [get_debug_cores u_ila_0_1]
set_property C_INPUT_PIPE_STAGES 0 [get_debug_cores u_ila_0_1]
set_property C_TRIGIN_EN false [get_debug_cores u_ila_0_1]
set_property C_TRIGOUT_EN false [get_debug_cores u_ila_0_1]
set_property port_width 1 [get_debug_ports u_ila_0_1/clk]
connect_debug_port u_ila_0_1/clk [get_nets [list u_ip_pll/inst/clk_out2]]
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0_1/probe0]
set_property port_width 8 [get_debug_ports u_ila_0_1/probe0]
connect_debug_port u_ila_0_1/probe0 [get_nets [list {spi_cmd[0]} {spi_cmd[1]} {spi_cmd[2]} {spi_cmd[3]} {spi_cmd[4]} {spi_cmd[5]} {spi_cmd[6]} {spi_cmd[7]}]]
create_debug_port u_ila_0_1 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0_1/probe1]
set_property port_width 8 [get_debug_ports u_ila_0_1/probe1]
connect_debug_port u_ila_0_1/probe1 [get_nets [list {spi_signal[0]} {spi_signal[1]} {spi_signal[2]} {spi_signal[3]} {spi_signal[4]} {spi_signal[5]} {spi_signal[6]} {spi_signal[7]}]]
create_debug_port u_ila_0_1 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0_1/probe2]
set_property port_width 1 [get_debug_ports u_ila_0_1/probe2]
connect_debug_port u_ila_0_1/probe2 [get_nets [list spi_end]]
create_debug_port u_ila_0_1 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0_1/probe3]
set_property port_width 1 [get_debug_ports u_ila_0_1/probe3]
connect_debug_port u_ila_0_1/probe3 [get_nets [list spi_start]]
set_property C_CLK_INPUT_FREQ_HZ 300000000 [get_debug_cores dbg_hub]
set_property C_ENABLE_CLK_DIVIDER false [get_debug_cores dbg_hub]
set_property C_USER_SCAN_CHAIN 1 [get_debug_cores dbg_hub]
connect_debug_port dbg_hub/clk [get_nets ps2_clk]
