...
set_property -dict {PACKAGE_PIN P20 IOSTANDARD LVCMOS33} [get_ports btn1];     #IO17½Ó²å¿×
set_property -dict {PACKAGE_PIN AA21 IOSTANDARD LVCMOS33} [get_ports btn2];     #IO17½Ó²å¿×
